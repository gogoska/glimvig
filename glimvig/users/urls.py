...
# разобрался как работает механизм этой активации и шифрования, потратил ТОННУ нервов и все это из-за того, что я не заметил изменения модуля относительно 
# прошлых записей. Пускай это тут лежит, обожаю django-registration. Лучший модуль, что я запомню на век. Мало того что он хардкодит пути к тэмплэйтам,
# не гибок, так он еще шикарную инструкцию имеет.